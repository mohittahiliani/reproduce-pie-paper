...
int main (int argc, char *argv[])
{
  ...
  bool printPieStats = false;
  bool  isPcapEnabled = true;
  std::string  pathOut = ".";
  bool writeForPlot = true;
  std::string pcapFileName = "fourth-onoff.pcap";
...
// Create and configure access link and bottleneck link
  ...
  Config::SetDefault ("ns3::PieQueue::MeanPktSize", UintegerValue (530));
  ...
  if (writeForPlot)
    {
      ...
      filePlotQueueNoDrop << pathOut << "/" << "fourth-onoff.plotme";
  ...
  flowmon.SerializeToXmlFile ("fourth-onoff.xml", true, true);
