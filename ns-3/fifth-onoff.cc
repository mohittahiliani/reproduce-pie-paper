/*
 * This script simulates a bursty UDP traffic for PIE evaluation (max burst = 100 ms)
...
int main (int argc, char *argv[])
{
  ...
  std::string pcapFileName = "fifth-onoff.pcap";
...
// Create and configure access link and bottleneck link
  ...
  if (writeForPlot)
    {
      ...
      filePlotQueueNoDrop << pathOut << "/" << "fifth-onoff.plotme";
  ...
  flowmon.SerializeToXmlFile ("fifth-onoff.xml", true, true);
