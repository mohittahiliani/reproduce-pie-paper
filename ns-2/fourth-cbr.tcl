#================================================================================
# This script simulates a bursty UDP traffic for PIE evaluation (max burst = 0ms)		     
...
set tracefile [open fourth-cbr.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open fourth-cbr.nam w]
...
Queue/PIE set mean_pktsize_ 500
...
Queue/PIE set burst_allowance_ 0
...
set trace_file_main tmp-fourth-cbr.tr
set trace_file_pie tmp-pie-fourth-cbr.tr
