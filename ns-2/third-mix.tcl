#=================================================================
# This script simulates mix TCP and UDP traffic for PIE evaluation		     
...
$ns duplex-link $n7 $n8 10.0Mb 50ms PIE
...
set trace_file_pie tmp-pie-third-mix.tr
$ns trace-queue $n7 $n8 [open $trace_file_main w]
set pie [[$ns link $n7 $n8] queue]
$pie trace curq_
$pie trace prob_
$pie trace qd_
